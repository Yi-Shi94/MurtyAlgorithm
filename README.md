...
For scipy.optimize.linear_sum_assignment, the return value is (row_idx,col_idx) -> (np.array,np.array). In my case, it's (n_solution, row_idx, col_idx) in a single numpy array. 
